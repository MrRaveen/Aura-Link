...
@Document("user_profilesMongo")
public class user_profilesMongo {
    @Id
    private String id;
    ...
    public user_profilesMongo(String first_name, String last_name,
                              String bio, String profile_pic_url,
                              String latLocation, String lonLocation,
                              Date birdth_date, LocalTime joined_at, int age,
                              int mobile, String address, String job,
                              String user_id) {
